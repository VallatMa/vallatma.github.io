...
assert((6270080) % 16 === 0, 'heap must start aligned to 16 bytes, DYNAMIC_BASE==' + 6270080);
assert(268435456 >= TOTAL_STACK, 'INITIAL_MEMORY should be larger than TOTAL_STACK, was ' + 268435456 + '! (TOTAL_STACK=' + TOTAL_STACK + ')');
...
updateGlobalBufferAndViews(buffer);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 6270080;
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=1027184;function __emscripten_get_fetch_work_queue() {
  ...
  var ___tm_current=1027040;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 1027088, 4), 1027088);function _gmtime_r(time, tmPtr) {
...
var _malloc,_free,_main,_memset,_Decompress_LZ4,_unsafeutility_malloc,_unsafeutility_free,_unsafeutility_assertheap,_unsafeutility_memclear,_unsafeutility_memcpystride,_unsafeutility_memcpyreplicate,_unsafeutility_memmove,_unsafeutility_freetemp,_unsafeutility_call_p,_unsafeutility_call_pi,_unsafeutility_get_heap_size,_rafcallbackinit_html,_GetOrCreateSharedMemory,_GetStatus,_Close,_GetData,_RequestAsyncRead,_BGFXAllocator_Init,_BGFXCB_Init,_BGFXCB_Lock,_BGFXCB_UnlockAndClear,_init_html,_shutdown_html,_RegisterSendMessage,_AtomicSafety_PushNode,_AtomicSafety_PopNode,_PlayerConnectionMt_IsAvailableSendStream,_PlayerConnectionMt_Init,_PlayerConnectionMt_DequeSendStream,_PlayerConnectionMt_LockStreamBuilders,_PlayerConnectionMt_UnlockStreamBuilders,_PlayerConnectionMt_Shutdown,_PlayerConnectionMt_AtomicAdd64,_PlayerConnectionMt_LockProfilerHashTables,_PlayerConnectionMt_UnlockProfilerHashTables,_PlayerConnectionMt_DequeFreeStream,_PlayerConnectionMt_AtomicCompareExchange,_PlayerConnectionMt_QueueFreeStream,_PlayerConnectionMt_QueueSendStream,_PlayerConnectionMt_RegisterStreamBuilder,_PlayerConnectionMt_AtomicStore,_Time_GetTicksToNanosecondsConversionRatio_Numerator,_Time_GetTicksToNanosecondsConversionRatio_Denominator,_Time_GetTicksMicrosecondsMonotonic,_strlen,_unsafeutility_realloc,_BGFXCB_DeInit,_time_html,_SendMessage,_unsafeutility_memset,_unsafeutility_memcpy,_PlayerConnectionMt_UnregisterStreamBuilder,_AtomicSafety_LockSafetyHashTables,_AtomicSafety_UnlockSafetyHashTables,_unsafeutility_memcmp,_GetErrorStatus,_CompressBound_LZ4,_Compress_LZ4,_GetSecondsMonotonic,_htonl,_htons,_ntohs,__get_tzname,__get_daylight,__get_timezone,stackSave,stackRestore,stackAlloc,___cxa_demangle,_memalign,___set_stack_limit,__growWasmMemory,dynCall_viiiii,dynCall_vi,dynCall_iiii,dynCall_v,dynCall_iii,dynCall_ii,dynCall_vii,dynCall_viii,dynCall_di,dynCall_ji,dynCall_fi,dynCall_viiiiii,dynCall_iiif,dynCall_viiiiiii,dynCall_iiiiiiiii,dynCall_viiii,dynCall_iij,dynCall_iid,dynCall_iiiiiii,dynCall_iiiii,dynCall_iif,dynCall_iiiiii,dynCall_viiiiiiii,dynCall_id,dynCall_i,dynCall_vijii,dynCall_iijii,dynCall_jiji,dynCall_iiiiji,dynCall_viiiiiiiii,dynCall_idi,dynCall_vffff,dynCall_vf,dynCall_vff,dynCall_vfi,dynCall_viif,dynCall_vif,dynCall_viff,dynCall_vifff,dynCall_viffff,dynCall_viiiiiiiiii,dynCall_viiiiiiiiiii,dynCall_viifi,dynCall_iidiiii;
